...
\[
\mathbf{y} = [y_\mathrm{L},\, y_\mathrm{R},\, y_\mathrm{C},\, y_\mathrm{Ls},\, y_\mathrm{Rs},\, y_\mathrm{Lrs},\, y_\mathrm{Rrs},\, y_\mathrm{LFE},\, y_\mathrm{Ltf},\, y_\mathrm{Rtf},\, y_\mathrm{Ltr},\, y_\mathrm{Rtr}]^\mathsf{T}
\]
